...
import AdminPanelEleminationFight from "./AdminPanelEleminationFight";

const AdminPanelEleminationRound = ({RoundId, RoundName, fights, onDeleteFighter, onPromoteFighter}) => {
...
export default AdminPanelEleminationRound;