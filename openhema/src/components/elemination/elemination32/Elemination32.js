...
const Elemination32 = ({eleminations, fighters}) => {
    ...
    const round3AArray = transformFights(eleminations.rounds[3].fights.slice(0,7), fighters);
    const round3BArray = transformFights(eleminations.rounds[3].fights.slice(6,15), fighters);
