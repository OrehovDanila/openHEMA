...
const ScoreboardControlPools = () => {
    ...
    const changeScore1 = (counter) => {
        ...
        set(ref(database, 'pools/' + activePool + '/fights/' + fightPos), patchedFight)
            .then(console.log(`Отправка на сервер 'pools/${activePool}/fights/${activeFightId}`))
...
export default ScoreboardControlPools;