...
//Дамб-компонент для рендера боёв плейофф

const AdminPanelEliminationFight = ({fightId, fighter1Id, fighter2Id, toogleEdition, onDeleteFighter, onPromoteFighter, fightIndex, RoundId}) => {
...
export default AdminPanelEliminationFight;